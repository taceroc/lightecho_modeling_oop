...
from DustShape import Cube, SphericalBlub, PlaneDust
...
class LE_image:
    ...
    def define_image_size(self, DustShape):
        if (isinstance(DustShape, Cube) or isinstance(DustShape, SphericalBlub) or isinstance(DustShape, PlaneDust)):
