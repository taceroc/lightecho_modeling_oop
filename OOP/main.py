...
import SimulateLEInfPlane, SimulateLECenterSphericalShell, SimulateLEFixPlane
...
prog_name = 'LESimulations'
description = '''Simulate some LE images'''
prog = 'main.py'
...
if __name__ == '__main__':
    if ins.funcsim == 'SimulateLEInfPlane':
        funcsim = SimulateLEInfPlane
    elif ins.funcsim == 'SimulateLECenterSphericalShell':
        funcsim = SimulateLECenterSphericalShell
    elif ins.funcsim == 'SimulateLEFixPlane':
        funcsim = SimulateLEFixPlane
...
### python main.py SimulateLEIFixPlane -file_to_parameters params_unknown_fixplane.txt --no-bool_save --bool_show_plots --bool_show_initial_object
...
def old():
    ...
    # p0_45  = [0.506645455682, -0.185724560275, -1.43998120646, 1.37626378129]
    # params = leastsq(residuals, p0_45, args=(points))[0]
